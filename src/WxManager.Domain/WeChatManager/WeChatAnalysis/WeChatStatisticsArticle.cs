...
{
    public class WeChatStatisticsArticle : Entity<int>
    {
        /// <summary>
        /// 微信数据源
        /// </summary>
        ...
        public virtual ICollection<WeChatStatisticsArticleDetail> StatisticsArticleDetails { get; set; } = new List<WeChatStatisticsArticleDetail>();
